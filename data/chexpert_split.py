...
2. Combines and splits into: train (70%), validation (10%), conformal (10%), test (10%)
3. Filters uncertain (-1.0) labels from train/validation/conformal (test keeps them)
...
def split_dataset():
    """Main splitting function for CheXpert."""
